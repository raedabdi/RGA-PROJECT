...
feat2_desc: "راقب توازنك العضلي وجاهزيتك العصبية (TSB). لا تترك عضلة خلف الأخرى! نظامنا الذكي يمنعك من الإصابة ويخبرك متى تكون مستعداً لكسر رقمك الشخصي التالي.",
feat3_title: "التسجيل اللايف التفاعلي",
feat3_desc: "سجل تمرينك في الوقت الفعلي. استخدم مؤقت الراحة الذكي الذي يتكيف مع شدة تمرينك، وتلقى تنبيهات فورية عندما تكون على وشك كسر رقمك القياسي (PR)!",
feat4_title: "ألعاب القوة الموسيقية",
feat4_desc: "حوّل وقت راحتك إلى تحدٍ ممتع! العب تحدي الديدليفت، وتحدي السكوات، وتحدى لعبة 'صائد الأوزان' الجديدة. مع كل كبسة، يتغير اللحن ليواكب حماسك، وكلما زاد السكور، زادت نقاط XP. هل أنت مستعد للإدمان؟",
...
// --- Features ---
feat1_title: "City Monster System",
feat1_desc: "Enter the battleground! Compete with friends in your city, break records, and claim the leaderboard's throne. When you break a record, you must submit video proof; once verified, you become the 'Wanted King'. Are you ready to rule?",
feat2_title: "Muscle Radar & Readiness",
feat2_desc: "Monitor your muscle balance and CNS readiness (TSB). Don't leave a muscle behind! Our smart system helps prevent injury and tells you exactly when you are ready to hit your next Personal Record (PR).",
feat3_title: "Interactive Live Tracking",
feat3_desc: "Log your workout in real-time. Use the smart rest timer that adapts to your set's intensity, and get instant alerts when you are about to break your Personal Record (PR)!",
feat4_title: "Musical Power Games",
feat4_desc: "Turn your rest time into fun challenges! Play Deadlift challenge, Squat challenge, and take on the new 'Iron Reflex' game. With every tap, the melody changes to match your intensity, and high scores mean higher XP rewards. Are you ready to get hooked?",
