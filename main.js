...
async function viewPlayerProfile(targetUid) {
    ...
    try {
        ...
        if (data.clanId) {
            ...
            clanInfoHTML = `
                <button class="btn-primary" style="width:100%; height: 50px; margin-top:15px; background: rgba(0, 242, 167, 0.1); border: 1px solid var(--primary-color); color:var(--primary-color); display: flex; align-items: center; justify-content: center; gap: 8px;" onclick="sendClanInvite('${targetUid}')">
