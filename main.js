...
}else if(notif.type==='admin_alert'){let savedData=JSON.parse(localStorage.getItem('currentUser')||'{}');if(savedData.isWorkoutPending){savedData.isWorkoutPending=!1;localStorage.setItem('currentUser',JSON.stringify(savedData))}
