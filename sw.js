const CACHE_NAME = 'rga-fit-v12'; // رفعنا النسخة عشان المتصفح يحدث الملفات
const ASSETS = [
  '/',
  '/index.html',
  '/dashboard.html',
...
// 1. تنزيل الملفات وتخزينها في الكاش
...
// 2. مسح الكاش القديم عند وجود تحديث
...
// 3. قراءة الملفات من الكاش لسرعة التحميل (مع استثناء فايربيس عشان ما يعلق)
self.addEventListener('fetch', (e) => {
  // تجاهل طلبات قاعدة البيانات والسيرفر
...
// --- إعدادات الفايربيس والإشعارات تبقى كما هي ---
