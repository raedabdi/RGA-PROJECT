const CACHE_NAME = 'rga-fit-v12'; // النسخة الجديدة لكسر الكاش القديم

// الملفات التي يجب حفظها ليعمل التطبيق بدون إنترنت
const ASSETS = [
  '/',
  '/index.html',
  '/dashboard.html',
...
self.addEventListener('fetch', (e) => {
  // 🔥 السحر هنا: استثناء طلبات قاعدة البيانات والسيرفر عشان ما يعلق التطبيق
...
// -----------------------------------------
// إعدادات الإشعارات والفايربيس (كودك الأصلي)
// -----------------------------------------
